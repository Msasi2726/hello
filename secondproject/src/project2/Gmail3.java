...
public class Gmail3 
{
	public static void main(String[] args) throws Exception 
	{
        ...
        driver.findElement(By.xpath("//span[text()='Next']")).click();
        Thread.sleep(4000);
        //Count no.of mails in Updates read and delete
        driver.findElement(By.xpath("(//table)[5]/tbody/tr/td[4]/descendant::div[6]")).click();
        List<WebElement> a=driver.findElements(By.xpath("(//table)[8]/tbody/tr"));
        System.out.println("Count of mails  "+a.size() );
        for(int i=1;i<a.size();)
        {
        	WebElement d=driver.findElement(By.xpath("(//table)[8]/tbody/tr["+i+"]/td[6]"));
        	d.click();
        	Thread.sleep(3000);
