...
public class Gmail4
{
	public static void main(String[] args) throws Exception 
	{
        ...
        driver.findElement(By.xpath("//span[text()='Next']")).click();
        Thread.sleep(4000);
        //Count no.of mails in Forums read and delete
        driver.findElement(By.xpath("(//table)[5]/tbody/tr/td[5]/descendant::div[6]")).click();
        Thread.sleep(3000);
        List<WebElement> a=driver.findElements(By.xpath("(//table)[9]/tbody/tr"));
        System.out.println("Count of mails  "+a.size() );
        Thread.sleep(3000);
        for(int i=1;i<a.size();)
        {
        	WebElement d=driver.findElement(By.xpath("(//table)[9]/tbody/tr["+i+"]/td[6]"));
        	d.click();
        	Thread.sleep(3000);
