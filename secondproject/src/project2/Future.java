...
public class Future 
{
	...
	public static void main(String[] args) throws Exception
	{
        ...
        //Login        
        driver.findElement(By.name("mobileNo")).sendKeys("XXXX");
        driver.findElement(By.name("password")).sendKeys("XXXX");
        driver.findElement(By.xpath("(//button[text()='Login'])[2]")).click();  
        //Send MSG with Smile in Future Sms
        //click on Future Sms
        driver.findElement(By.xpath("//a[@href='future-sms']")).click();
        //
        driver.findElement(By.name("toMobile")).sendKeys("XXXX");
        ...
        Thread.sleep(3000);
        driver.findElement(By.name("sdate")).clear();
        driver.findElement(By.name("sdate")).sendKeys("11/07/2018");
        Thread.sleep(3000);
        driver.findElement(By.name("stime")).clear();
        driver.findElement(By.name("stime")).sendKeys("10:15");
